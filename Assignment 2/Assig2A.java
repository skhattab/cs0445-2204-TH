...
public class Assig2A
{
	...
	public static void main(String [] args)
	{
		...
		SequenceInterface<Integer> theS = new LinkedDS<>(DIGITS);
	  ...
	  char1 = 'r';
		...
		SequenceInterface<Character> word = new LinkedDS<>(LETTERS);
		String w = "tures aref";
		...
		LinkedDS<Integer> newDS = new LinkedDS<>(DIGITS);
		for (int i = 0; i < 8; i++)
		{
		...
		SequenceInterface<Integer> largeNumber = new LinkedDS<>(DIGITS);
